...
<nav class="navbar navbar-default" role="navigation">
	...
	<div>
		<ul class="nav navbar-nav">
			<li class="active"><a href="RankAction!movieRank">电影</a></li>
...
<div class="col-xs-4">
	<div class="jumbotron">
	    <table class="table table-striped" id="table1">
	        ...
	        <tbody>
	            <s:iterator value="topredumovies" id="column">
				    <tr>
...
<div class="col-xs-4">
	<div class="jumbotron">
	    <table class="table table-striped" id="table1">
	        ...
	        <tbody>
	            <s:iterator value="topwatchermovies" id="column">
				    <tr>
    			    	<td><s:property value="mid"/></td>
     			    	<td><s:property value="watchernum"/></td>
     			    </tr>
     		    </s:iterator>
	        </tbody>
		</table>
...
<div class="col-xs-4">
	<div class="jumbotron">
	    <table class="table table-striped" id="table1">
	        ...
	        <tbody>
	            <s:iterator value="topscoremovies" id="column">
				    <tr>
    			    	<td><s:property value="mid"/></td>
